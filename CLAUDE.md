...
| `js/main.js` (~1300 lines) | Controller. Init sequence, input dispatch (`handleInput` -> per-tab handlers), game loop (adaptive: 20fps active / 4fps idle / 1fps hidden), modal/crime-detail orchestration. |
